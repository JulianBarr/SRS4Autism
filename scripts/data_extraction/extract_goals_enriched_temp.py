...
def main():
    ...
    # --- UPDATED PATHS FOR THE SUBSET RUN ---
    skeleton_path = os.path.join(base_dir, "22_cognition_skeleton.json")
    pdf_path = os.path.join(base_dir, "22-cognition-pg14-60.pdf")
    output_path = os.path.join(base_dir, "22_cognition_enriched_abox_part1.json")
    # ----------------------------------------
