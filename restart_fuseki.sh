...
java -Xmx4G -jar fuseki-server.jar --file=/Users/maxent/src/SRS4Autism/knowledge_graph/world_model_merged.ttl /srs4autism > /Users/maxent/src/SRS4Autism/data/logs/fuseki.log 2>&1 &
